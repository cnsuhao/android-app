...
public class BarCode2 extends Entity implements Serializable {
    ...
    public static BarCode2 parse(String barCodeString) throws JSONException {
        BarCode2 barCode = new BarCode2();
        // 由字符串创建json对象
