...
public class XmlUtils {
    ...
    public static <T> T toBean(Class<T> type, InputStream is) {
        ...
        xmStream.registerConverter(new MyIntConverter());
        xmStream.registerConverter(new MyLongConverter());
        xmStream.registerConverter(new MyFloatConverter());
        xmStream.registerConverter(new MyDoubleConverter());
