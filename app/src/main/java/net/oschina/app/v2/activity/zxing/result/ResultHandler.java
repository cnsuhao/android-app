...
package net.oschina.app.v2.activity.zxing.result;
...
import net.oschina.app.v2.activity.zxing.Contents;
import net.oschina.app.v2.activity.zxing.LocaleManager;
import net.oschina.app.v2.activity.zxing.PreferencesActivity;
