...
public class UserProfileFragment extends BaseFragment {
        ...
        public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
            try {
                ...
                if (info != null) {
                    ...
                    new SaveCacheTask(getActivity(), info, getCacheKey()).execute();
                } else {
    ...
    private void readCacheData(String key) {
        cancelReadCacheTask();
        mCacheTask = new ReadCacheTask(getActivity()).execute(key);
    }
    ...
    private class ReadCacheTask extends AsyncTask<String, Void, MyInformation> {
