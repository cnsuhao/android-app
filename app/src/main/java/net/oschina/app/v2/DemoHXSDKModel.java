...
import net.oschina.app.v2.easemob.db.DbOpenHelper;
import net.oschina.app.v2.easemob.db.UserDao;
import net.oschina.app.v2.easemob.model.DefaultHXSDKModel;
import net.oschina.app.v2.model.chat.User;
