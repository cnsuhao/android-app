...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((MessageActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((MessageActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		String st = activity.getResources().getString(R.string.tip_voice_downloading);
		if (isPlaying) {
			if (((MessageActivity) activity).playMsgId != null && ((MessageActivity) activity).playMsgId.equals(message.getMsgId())) {
