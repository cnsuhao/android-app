...
import net.oschina.app.v2.activity.event.adapter.EventTabPagerAdapter;
import net.oschina.app.v2.activity.common.SimpleBackActivity;
import net.oschina.app.v2.base.Constants;
import net.oschina.app.v2.ui.tab.SlidingTabLayout;

public class EventViewPagerFragment extends Fragment implements
	...
	private EventTabPagerAdapter mTabAdapter;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		if (mTabAdapter == null) {
			mTabAdapter = new EventTabPagerAdapter(getChildFragmentManager(),
