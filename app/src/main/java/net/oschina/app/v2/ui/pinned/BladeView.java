package net.oschina.app.v2.ui.pinned;
...
public class BladeView extends View {
    ...
    private void showPopup(int item) {
        if (mPopupWindow == null) {
            ...
            mPopupText.setBackgroundResource(R.drawable.index_toast_bg);
            //setBackgroundColor(Color.GRAY);
            mPopupText.setTextColor(Color.WHITE);
            mPopupText.setTextSize(TypedValue.COMPLEX_UNIT_SP, 30);
        ...
        if (mPopupWindow.isShowing()) {
            ...
            mPopupWindow.showAtLocation(showView == null ? getRootView() : showView,
