...
package net.oschina.app.v2.activity.qrcode.decode;
...
import net.oschina.app.v2.activity.qrcode.Intents;
...
final public  class DecodeFormatManager {
    ...
    static public Set<BarcodeFormat> parseDecodeFormats(Intent intent) {
    ...
    static public Set<BarcodeFormat> parseDecodeFormats(Uri inputUri) {
