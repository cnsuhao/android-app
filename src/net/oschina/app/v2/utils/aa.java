...
public final class aa
{
    ...
    {
        return (int) TypedValue.applyDimension(1, 40F, context.getResources().getDisplayMetrics());
    }
    ...
    public static void a(View view, android.view.View.OnClickListener onclicklistener,
            int ai[])
    {
